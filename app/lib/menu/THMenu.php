...
class THMenu extends TElement
{
     ...
     */
    public function addMenuItem(THMenuItem $menuitem)
    {
    ...
    public function parse($xml, $permission_callback = NULL)
    {
        ...
        foreach ($xml as $xmlElement)
        {
            ...
            $menu     = NULL;
            $menuItem = new THMenuItem($label, $action, $icon, $this->menu_level);
            ...
            if ($xmlElement->menu)
            {
                ...
                $menu = new THMenu($xmlElement-> menu-> menuitem, $permission_callback, $this->menu_level +1, $menu_class, $this->item_class, $this->link_class, $this->item_transformer);
